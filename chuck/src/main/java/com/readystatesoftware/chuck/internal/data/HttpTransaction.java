...
public class HttpTransaction {
    ...
    public boolean isOtherNetWorkFramework() {
        return otherNetWorkFramework;
    }

    public void setOtherNetWorkFramework(boolean otherNetWorkFramework) {
        this.otherNetWorkFramework = otherNetWorkFramework;
    }

    private boolean otherNetWorkFramework = false;
